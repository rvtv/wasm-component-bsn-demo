...
export * as stringLengthValidation from './interfaces/summit25-validator-string-length-validation.js'; // export summit25:validator/string-length-validation@0.0.1
