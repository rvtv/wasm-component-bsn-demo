...
let stringLengthValidation001Validate;

function validate(arg0, arg1) {
  var ptr0 = utf8Encode(arg0, realloc0, memory0);
  var len0 = utf8EncodedLen;
  const ret = stringLengthValidation001Validate(ptr0, len0, toInt32(arg1));
  var bool1 = ret;
  const retVal = bool1 == 0 ? false : (bool1 == 1 ? true : throwInvalidBool());
  postReturn0(ret);
  return retVal;
}
...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./string_length_validator.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./string_length_validator.core2.wasm', import.meta.url));
    ...
    postReturn0 = exports1['cabi_post_summit25:validator/string-length-validation@0.0.1#validate'];
    stringLengthValidation001Validate = exports1['summit25:validator/string-length-validation@0.0.1#validate'];
  })();
...
await $init;
const stringLengthValidation001 = {
  validate: validate,
  
};

export { stringLengthValidation001 as stringLengthValidation, stringLengthValidation001 as 'summit25:validator/string-length-validation@0.0.1',  }