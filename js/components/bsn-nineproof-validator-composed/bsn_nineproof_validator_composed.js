...
let stringValidation001Validate;

function validate(arg0) {
  var ptr0 = utf8Encode(arg0, realloc3, memory1);
  var len0 = utf8EncodedLen;
  const ret = stringValidation001Validate(ptr0, len0);
  var bool1 = ret;
...
const $init = (() => {
  let gen = (function* init () {
    const module0 = fetchCompile(new URL('./bsn_nineproof_validator_composed.core.wasm', import.meta.url));
    const module1 = fetchCompile(new URL('./bsn_nineproof_validator_composed.core2.wasm', import.meta.url));
    ...
    const module4 = fetchCompile(new URL('./bsn_nineproof_validator_composed.core3.wasm', import.meta.url));
    const module5 = fetchCompile(new URL('./bsn_nineproof_validator_composed.core4.wasm', import.meta.url));
    ...
    const module8 = base64Compile('');
    ...
    realloc3 = exports5.cabi_realloc;
    stringValidation001Validate = exports5['summit25:validator/string-validation@0.0.1#validate'];
  })();
...
await $init;
const stringValidation001 = {
  validate: validate,
  
};

export { stringValidation001 as stringValidation, stringValidation001 as 'summit25:validator/string-validation@0.0.1',  }