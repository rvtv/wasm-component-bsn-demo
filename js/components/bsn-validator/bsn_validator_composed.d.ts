...
export * as stringValidationRunner from './interfaces/summit25-validator-string-validation-runner.js'; // export summit25:validator/string-validation-runner@0.0.1
